...
//! | `resource_limiter_active_tasks`   | Gauge      | Active-task count per resource category, labeled by `category` |
//! | `resource_limiter_limit`          | Gauge      | Configured concurrency limit per resource category, labeled by `category` |
//!
//! ## Configuration
//!
